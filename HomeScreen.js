...
// List of addresses of buildings that are a part of the ASU Tempe campus
...
// When 0, pickup can be selected. When 1, destination can be selected
clickFlag = 0;
  ...
  // Returns the closest address to the coordinates stored in myCoordinates
  ...
  // Determines whether a given address is within the ASU Tempe campus and surrounding streets area
  ...
  // Runs when the submit button is pressed and both pickup and destination are filled in
  ...
  // Runs when the interactive map is pressed
  ...
  // Runs when the "Select pickup" or "Select Destination" text are pressed
  ...
  // Gets the destination of the submitted route
  ...
  // Adds the route duration to the current time to get the arrival time
  ...
  return (
    // Contains all GUI elements and associates them with functions
