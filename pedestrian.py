...
class LineFollower:
    ...
    def get_i_color(self, cam_img):
        ...
        (regions, weights) = self.hog.detectMultiScale(cam_img, winStride=(4, 4), padding=(4, 4), scale=1.05)
        
            

        # return max_yellow, hist[max_yellow], regions
        return 0,0,regions
...
"""
    ...
    def overlay_display(self, cam_img, regions, max_yellow, confidense):
        '''
